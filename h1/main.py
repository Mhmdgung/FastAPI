...
#     user_id: int, item_id: int, desc: str = None, short: bool = False
#     ):
#     item = {"item_id": item_id, "owner_id": user_id}
#     if desc:
#         item.update({"desc": desc})
#     if not short:
#         item.update({"detail": "This item without short"})
#     return item
...
#     size: Annotated[float | None, Query(gt=0, lt=9.5)] = None
# ):
...
async def create(images: list[Image]):
    return images